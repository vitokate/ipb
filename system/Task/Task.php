...
class _Task extends \IPS\Patterns\ActiveRecord
{
	...
	public static function runQueue()
	{
		...
		/* @note SELECT_FROM_WRITE_SERVER: Avoid race conditions with the task locking/finishing */
		$queueData	= \IPS\Db::i()->select( '*', 'core_queue', array( \IPS\Db::i()->in('app', $enabledApps ) ), 'priority ASC, RAND()', 1, NULL, NULL, \IPS\Db::SELECT_FROM_WRITE_SERVER )->first();
		$newOffset	= 0;
