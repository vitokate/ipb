...
$lang = array(
	...
	'login_err_no_account'			=> "The {!#[1:display name or password][2:email address or password][3:display name, email address or password]} was incorrect. Please try again (make sure your caps lock is off).",
	'login_err_bad_password'		=> "The {!#[1:display name or password][2:email address or password][3:display name, email address or password]} was incorrect. Please try again (make sure your caps lock is off).",
	...
	'requirements_mysql_format_advice'	=> "You have one or more InnoDB tables that are using the `Compact` row format. This may limit the amount of data that can be stored within the table. We recommend changing it to 'Dynamic'. %s If you are not sure how to do this, you should contact your hosting provider or system administrator for assistance.",
	'requirements_mysql_ifpt_advice'	=> "Please make sure that `<a href='https://dev.mysql.com/doc/refman/5.7/en/innodb-parameters.html#sysvar_innodb_file_per_table' target='_blank'>innodb_file_per_table</a>` is enabled.",
...
'files-7'	=> "Response returned a 400 response code but no Amazon region was returned: %s",
	...
	'105000_prune_desc'						=> "New pruning options have been introduced in this release which will remove old item markers, follow records, member IP addresses and known member devices. Pruning this data can reduce the size of your database, improving your site's performance and potentially saving you money, however it will mean that unread markers will be reset and follow records will be removed for members who have not visited for a long period of time, and IP addresses and devices will be removed after a year. The time periods to retain this data can be configured in the AdminCP after upgrading. Do you wish to use the new pruning default values?",
	'105000_prune_disable'					=> "I will configure this later",
	'105000_prune_enable'					=> "Use new pruning defaults",


	/* !Core - 4.5 - Notification Settings */
	'105000_admin_reg_customized'	=> "Reverting Customized Email Template",
	'105000_notifications'			=> "Notification Options",
	'notification_method_inline'	=> "Notification List",
	'notification_method_email'		=> "Email",
	'notification_editable_yes'		=> "Yes, members can choose how they want to receive these notifications",
	'notification_editable_no'		=> "No",
	'105000_notifications_editable' => "%s: Should this option be EDITABLE?",
	'105000_notifications_default'	=> "%s: What should the DEFAULT options be?",
	'105000_notifications_disabled'	=> "%s: What should the DISABLED options be?",
	'notifications__content'	=> "Followed Content",
	'notifications__content_desc'=> "These notifications will be sent whenever there is new activity on things you are following and have opted to receive immediate notifications for.",
	'notifications__members'	=> "Followed Members",
	'notifications__members_desc' => "These notifications will be sent whenever a member you are following makes a post.",
	...
	'notifications__report_center'		=> "Reports",
	'notifications__report_center_desc'	=> "These notifications will be sent whenever a user reports content that you are able to moderate.",
	'notifications__unapproved_content'		=> "Moderator Approval",
	'notifications__unapproved_content_desc' => "These notifications are sent whenever content is posted that requires a moderator to manually approve it and you are able to do so.",
	'notifications__automatic_moderation' => "Automatic moderation",
	'notifications__automatic_moderation_desc' => "These notifications will be sent when something has been reported enough times that it is automatically hidden.",
	'notifications__warning_mods'		=> "Warnings",
	'notifications__warning_mods_desc'	=> "These notifications will be sent whenever another moderator issues a warning.",
	'notifications__new_file_version'	=> "File Updates",
	'notifications__event_reminder'	=> "Event Reminders",
	
	/* ! Core - 4.6 Achievements options */
	'106000_rule_option' => "Achievements",
	'106000_rule_option_desc' => "Please see our <a href='https://invisioncommunity.com/news/product-updates/drum-roll-please…-announcing-achievements-r1227/' target='_blank'>achievements announcement</a> for more information.",
	'106000_rule_option_new' => "Use new default ranks",
	'106000_rule_option_new_desc' => "Install the new ranks and use the default rules to generate points by posting, following and more.",
	'106000_rule_option_old' => "Keep my current ranks",
	'106000_rule_option_old_desc' => "Retain current ranks and continue increasing ranks just by posting",
	...
	'method_issue_security'   => 'Conflicting security level',
	'method_issue_static'     => 'Inconsistent static declaration',
	'method_issue_return_type'    => 'Conflicting return type hints',
	'method_issue_parameter_type' => 'Conflicting parameter type',
	'method_issue_nullable'       => 'Conflicting parameter nullability',
	'method_issue_reference'      => 'Conflicting reference',
	...
	'method_app'     => 'App',
	'method_reason'  => 'Issue',
	'method_scanner_method'  => 'Method',
	'method_subclassFile'    => 'Subclass/Hook File',
	'method_baseFile'    => 'Base Class File',
