...
class _upcomingEvents extends \IPS\Widget\PermissionCache
{
	...
	public function render()
	{
		...
		$events = \IPS\calendar\Event::retrieveEvents( $_today, $endDate, ( $calendars === NULL ? array_keys($noneClubCalendars ) : ( !\is_array( $calendars ) ? array( $calendars ) : $calendars ) ), $count, FALSE );
