...
class _Pages extends \IPS\core\FrontNavigation\FrontNavigationAbstract
{
	...
	public function active()
	{
		...
		try
		{
			if ( $db = $page->getDatabase() and $db->allow_club_categories and $categoryClass = '\\IPS\\cms\\Categories' . $db->id and \IPS\cms\Databases\Dispatcher::i()->categoryId and $categoryClass::load( \IPS\cms\Databases\Dispatcher::i()->categoryId )->club() )
			{
				return false;
			}
		}
